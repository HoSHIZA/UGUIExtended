...
namespace ShizoGames.ImprovedUI.Components
{
    ...
    [AddComponentMenu(PackageConfig.ADD_COMPONENT_UI_ROOT + "Anchor Snap")]
    public sealed class AnchorSnap : MonoBehaviour
    {
        ...
        private void Start()
        {
            _container = _container ? _container : transform.parent as RectTransform;
        ...
        /// <summary>
        /// A readonly struct that represents a segment in the grid.
        /// </summary>
